...
# - To add custom linebreaks in text sections, type NEWLINE (all upper case). These will
# be automatically converted to the HTML tag <br> for linebreaks.
# - To add 'Font Awesome' (FA) icons for links to websites/Twitter/GitHub/GoogleScholar,
# type ICON_WEBSITE, ICON_TWITTER, ICON_GITHUB, or ICON_SCHOLAR. These will be converted
# into the HTML code for the icons.
...
tbl_lukas <- data.frame(
  ...
  bio = c("Lukas Weber", 
          paste0(#"Website ICON_WEBSITE [testing](https://www.google.ch/)NEWLINE", 
                 ...
                 "GitHub ICON_GITHUB [lmweber](https://github.com/lmweber)NEWLINE", 
                 "Google Scholar ICON_SCHOLAR [link](https://scholar.google.ch/citations?user=M8uPSzMAAAAJ)"), 
...
for (i in seq_along(tables_all)) {
  kable(tables_all[[i]]) %>% 
    ...
    gsub("ICON_SCHOLAR", '<i class="fa fa-newspaper-o"></i>', .) %>% 
    print
}
```

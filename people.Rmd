...
# To add 'Font Awesome' (FA) icons for links to website/Twitter/GitHub, type WEBSITE_ICON,
# TWITTER_ICON, or GITHUB_ICON. These will be converted into the HTML code for the icons.
...
tbl_lukas <- data.frame(
  img = "![](img/lukas.jpg)", 
  bio = c("Lukas Weber", 
          paste0(#"Website WEBSITE_ICON [testing](https://www.google.ch/)NEWLINE", 
                 "Twitter TWITTER_ICON [\\@lmwebr](https://twitter.com/lmwebr)NEWLINE", 
                 "GitHub GITHUB_ICON [lmweber](https://github.com/lmweber)"), 
...
for (i in seq_along(tables_all)) {
  kable(tables_all[[i]]) %>% 
    ...
    gsub("WEBSITE_ICON", '<i class="fa fa-desktop"></i>', .) %>% 
    gsub("TWITTER_ICON", '<i class="fa fa-twitter"></i>', .) %>% 
    gsub("GITHUB_ICON", '<i class="fa fa-github"></i>', .) %>% 
    print
}
```

...
tbl_vlad <- data.frame(
   ...
   bio = c("Vladyslav Korobeynyk",
           ...
           paste0("I did my master thesis in single cell analysis of the adult mouse hippocampus in Jessberger Lab, HIFO, UZH. Shortly after, I sta    rted working as an intern in Systems Biology group at Roche, where I gained experience in ML and different type of sequencing technologies. Curren    tly I am doing a shared PhD with Jessberger Lab, where my project is based on using single-cell and spatial transcriptomics data to identify molec    ular changes, mainly in the neurogenic niche, that drive neurogenesis to decline with age. "),

...
tbl_simone <- data.frame(
  ...
  bio = c("Simone Tiberi", 
          ...
          paste0("I am a Postdoc working on the development of cutting-edge ",
                 ...
                 "In particular, I am currently focusing on two methodological projects. ",
                 "The first one consists in developing a Bayesian hierarchical model to identify differentially spliced genes, ",
                  "via  differential transcript usage (DTU), from bulk RNA-seq data. ",
                  "The second project (in its early stages) aims at creating a methodology, ",
                 "based on permutation tests, to perform differential state analyses from single-cell RNA-seq data. ",
                 "Previously, I was a PhD student at the Department of Statistics at the University of Warwick, ", 
                 "where I worked on Bayesian hierarchical models to investigate stochastic systems in single cells. ",
...
tbl_will <- data.frame(
  ...
  bio = c(
    ...
    paste0(
      "PhD in Computational Biology (2018), ETH Zurich <br/>",
...
tbl_stefan <- data.frame(
  ...
  bio = c("Stefan Milosavljevic",
          ...
          paste0("MSc in Computational Biology and Bioinformatics (2017), ETH Zurich and University of Zurich<br>", 
...
tbl_helena <- data.frame(
  ...
  bio = c("Helena Lucia Crowell", 
          ...
          paste0("MSc in Computational Biology & Bioinformatics (2018), ETH Zurich<br>", 
...
tbl_reto <- data.frame(
  ...
  bio = c("Reto Gerber",  
          paste0("I am a Master student in the Computational Biology & Bioinformatics study program currently  ",
                 "working on my master thesis. The focus of this project lies on using censored predictors in ",
                  " single cell models (mainly for flow and mass cytometry).",
                 " In past projects I worked among other things on docking of biomolecules and signalling networks in cells, ",
                  "before turning more to the statistical aspect of bioinformatics."
                  ), 
          paste0("BSc of Science in Biology (2017), University of Zurich"))
)

tbl_elyas <- data.frame(
  img = "![](img/thumbnail/elihei.jpeg)", 
  bio = c("Elyas Heidari",  
          paste0("I am a Master student of Computational Biology & Bioinformatics at ETH university.",
                 "I am mainly interested in developing analysis pipelines for single-cell multi-omics data.",
                  "  Prior to joining Robinson lab I have been conducting research on development of Machine Learning,", "and Deep Learning  methods for biomedical data. I have developed [MUVIS](https://baio-lab.github.io/muvis/index.html) for general medical data analysis",
                 "and [SeqLearner](http://seqlearner.readthedocs.io/) for semi-supervised learning on biological sequences."
                  ), 
          paste0("BSc of Science in Applied Mathematics (2019), Sharif University of Technology, Tehran<br>", "BSc of Science in Computer Engineering (2019), Sharif University of Technology, Tehran<br>"))
)
...
- Imran Fanaswala (Research Assistant, worked on assembly with PacBio and Illumina DNA-seq; now at [SimplicityBio](http://www.simplicitybio.com/))

...
# - To add custom linebreaks in text sections, type __NEWLINE. These will be automatically
# converted to the HTML tag <br> for linebreaks.
# - To add 'Font Awesome' (FA) icons for links to websites/Twitter/GitHub/GoogleScholar,
# type __ICON_WEBSITE, __ICON_TWITTER, __ICON_GITHUB, or __ICON_SCHOLAR. These will be
# converted into the HTML code for the icons.
# - To add additional FA icons (e.g. LinkedIn), select an FA icon (e.g. from
# https://www.w3schools.com/icons/fontawesome_icons_webapp.asp) and add similar code
# below, including the 'gsub' step at the very end.
...
tbl_mark <- data.frame(
  ...
  bio = c("Mark Robinson", 
          ...
          paste0("More text (e.g. qualifications)__NEWLINE", 
                 "More text"))
)
...
tbl_charlotte <- data.frame(
  ...
  bio = c("Charlotte Soneson", 
          ...
          paste0("PhD in Mathematics (2011), Lund University__NEWLINE", 
...
tbl_simone <- data.frame(
  ...
  bio = c("Simone Tiberi", 
          ...
          paste0("PhD in Statistics (2017), The University of Warwick__NEWLINE", 
                 "MSc in Statistics (2012), The University of Padua__NEWLINE", 
...
tbl_lukas <- data.frame(
  img = "![](img/lukas.jpg)", 
  bio = c("Lukas Weber", 
          paste0(#"[Website](https://www.google.ch/) __ICON_WEBSITE__NEWLINE", 
                 "Twitter __ICON_TWITTER [\\@lmwebr](https://twitter.com/lmwebr)__NEWLINE", 
                 "GitHub __ICON_GITHUB [lmweber](https://github.com/lmweber)__NEWLINE", 
                 "[Google Scholar](https://scholar.google.ch/citations?user=M8uPSzMAAAAJ) __ICON_SCHOLAR"), 
...
tbl_stephan <- data.frame(
  ...
  bio = c("Stephan Schmeing", 
          ...
          paste0("MSc in Astro, Particle and Nuclear physis (2014), TU Munich__NEWLINE", 
...
tbl_fiona <- data.frame(
  ...
  bio = c("Ruizhu Huang", 
          paste0("My major research interest is in the development and application of statistical ", 
                 ...
                 "signal aggregation."), 
          paste0("MSc in Biostatistics (2015), University of Zurich__NEWLINE", 
...
tbl_vladimir <- data.frame(
  ...
  bio = c("Vladimir Barbosa C. de Souza", 
          ...
          paste0("MSc in Applied Statistics (2015), University of Vicosa__NEWLINE", 
...
tbl_stephany <- data.frame(
  ...
  bio = c("Stephany Orjuela", 
          ...
          paste0("MSc in Biology (2017), University of Zurich__NEWLINE", 
...
tbl_stefan <- data.frame(
  ...
  bio = c("Stefan Milosavljevic", 
          ...
          paste0("MSc in Computational Biology and Bioinformatics (2015), ETH Zurich and University of Zurich__NEWLINE", 
...
tbl_helena <- data.frame(
  ...
  bio = c("Helena Lucia Crowell", 
          ...
          paste0("MSc in Computational Biology & Bioinformatics (present), ETH Zurich__NEWLINE", 
...
for (i in seq_along(tables_all)) {
  kable(tables_all[[i]]) %>% 
    ...
    gsub("__ICON_WEBSITE", '<i class="fa fa-desktop"></i>', .) %>% 
    gsub("__ICON_TWITTER", '<i class="fa fa-twitter"></i>', .) %>% 
    gsub("__ICON_GITHUB", '<i class="fa fa-github"></i>', .) %>% 
    gsub("__ICON_SCHOLAR", '<i class="fa fa-newspaper-o"></i>', .) %>% 
    print
}
```

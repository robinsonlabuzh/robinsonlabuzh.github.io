...
tbl_reto <- data.frame(
  ...
  bio = c("Reto Gerber",  
          paste("I am a Research Assistant in the Robinson lab. In my lastest project I developed a
                 method for differential abundance analysis in cytometry where a covariate is subject to censoring 
                 (Preprint on [bioRxiv](https://doi.org/10.1101/2020.11.09.374447)). Currently I develop 
                a R shiny web app helping in exploration and visualization of open access publication profiles of individual authors.
          ...
          paste0("MSc of Science in Computational Biology and Bioinformatics (2020), ETH, University of Zürich"),

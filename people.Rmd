...
tbl_meenu <- data.frame(
  img = "![](img/thumbnail/Meenu.jpeg)",
  bio = c("Meenu Bhati",
          paste0("<i class='fa fa-newspaper-o'></i> [Google Scholar](https://scholar.google.com/citations?user=l2kH-6EAAAAJ&hl=en&authuser=1)"),
          paste0("My research focuses on understanding genome biology across species from functional and evolutionary ",
                 "perspectives. I integrate genetics and multi-omics approaches to investigate regulatory mechanisms ",
                 "within the non-coding genome, with particular emphasis on long non-coding RNAs. Through this work, ",
                 "I aim to advance the functional interpretation of regulatory variation associated with complex traits ",
                 "while developing computational resources for the broader scientific community."),
          paste0("PhD in Animal Genomics (2024), ETH Zurich, Switzerland<br>",
                 "MSc in Animal Genomics & Breeding (2017), Wageningen University, Netherlands<br>",
                 "BVSc&AH in Veterinary & Animal Sciences (2014), Rajasthan University of Veterinary and Animal Sciences, India"))
)
...
tbl_jiayi <- data.frame(
  ...
  bio = c("Jiayi Wang",
          ...
          paste0("After finishing an internship and my master thesis in the Robinson group, I joined as a PhD student. During this time I worked on disentangling type and state effects on expression variability to improve analysis and interpretability of scRNA-seq data and identifying motif accessibility changes in ATAC-seq data. My PhD project primarily focuses on data analysis of long-read scRNA data and image analysis. "),
          paste0("MSc in Computational Biology and Bioinformatics (2024), ETH Zürich<br>",
                 "BSc in Biomedical Sciences (2021), University College London")
          )
)

tbl_marusa <- data.frame(
  img = "![](img/thumbnail/marusa.jpg)",
  bio = c(
          "Maruša Koderman",
          paste0("I joined the Robinson lab as a PhD student in 2024. Prior to starting my PhD, ",
                 "I worked as in intern at Roche (Pharma Research and Early Development), ",
                 "where I focused on single-cell data analysis and construction of human brain cell type atlases. ",
                 "In my PhD, I am continuing this work by leveraging large-scale multimodal single-cell atlases to ",
                 "advance the development of in vitro model systems and investigate new potential drug targets."),
          paste0("MSc in Laboratory Biomedicine (2021), University of Ljubljana<br>",
                 "BSc in Laboratory Biomedicine(2017), University of Ljubljana")
          )
)
...
tbl_pauline <- data.frame(
  img = "![](img/thumbnail/pauline.jpg)",
  bio = c("Pauline Busch",
          paste0("<i class='fa fa-linkedin-square'></i> [LinkedIn](www.linkedin.com/in/pauline-busch)<br>"),
          paste0("I joined the Robinson lab as a PhD student at the end of 2024. My background is in biomedical research, with previous work focusing on pathophysiological processes in blood and brain. During my master’s studies I developed an interest in bioinformatics and during my PhD I aim to contribute to the development of methods for analyzing spatial transcriptomics data."),
          paste0("MSc in Molecular Life Sciences (2022), University of Hamburg<br>",
                 "BSc in Biology (2019), University of Hamburg")
          )
)

tbl_ben <- data.frame(
  img = "![](img/thumbnail/ben.jpg)",
  bio = c("Ben Carrillo",
          paste0("PhD student at Robinson lab since Spring 2025. I am interested in building robust, composable tools for reproducible biomedical research. Working on tools for methods benchmarking."),
          paste0("MSc in Biostatistics and Bioinformatics (2023), Universitat Oberta de Catalunya<br>")
          )
)

tbl_noe <- data.frame(
  img = "![](img/thumbnail/noemi.jpeg)",
  bio = c("Noemi Loffredi",
          paste0("I am an external Master's student of Biotechnology and Applied AI. I am currently working on my thesis at Robinson lab focusing on the analysis of spatial omics features, with the aim of evaluating their relevance in biological systems. "),
          paste0("MSc in Biotechnology and Applied AI for Health, University of Pisa and Aix-Marseille University (ongoing)<br>",
                 "BSc in Biotechnology, University of Pisa(2024)")
          )
)

tbl_elif <- data.frame(
  img = "![](img/thumbnail/elif.jpg)",
  bio = c("Elif Zeynep Demir",
          paste0("I am a visiting Master’s student in Bioengineering, with particular interests in single-cell transcriptomics and computational cancer biology. At the Robinson Lab, my work focuses on using OmniBenchmark to study how preprocessing and representation choices alter the geometry of single-cell RNA-seq data."),
          paste0("MSc in Bioengineering, Marmara University (ongoing)<br>",
                 "BSc in Molecular Biology and Genetics, Bahçeşehir University (2024)")
          )
)
```
...
## Alumni
- [Izaskun Mallona](https://izaskunmallona.org/) (Senior researcher)
- Daniel Incicau (research assistant)
- Reto Gerber (PhD Student; author of [MIMIC](https://github.com/retogerber/MIMIC) among various other things)
- Pierre-Luc Germain (Shared postdoc; author of [scDblFinder](https://www.bioconductor.org/packages/scDblFinder) among various other things)
- Anna Schuster (MSc student)
- Sarusan Kathirchelvan (MSc student)
- Almut Lütge (PhD student; author of [CellMixS](https://www.bioconductor.org/packages/release/bioc/html/CellMixS.html); now Biomedical Data Engineer at [Swiss Data Science Center](https://datascience.ch))
- Anthony Sonrel (PhD student; now Bioinformatics Scientist @Idorsia)
- Yin Guo (visiting PhD student from Xi'an Jiaotong University)
- Helena Crowell (PhD student; author of [CATALYST](https://bioconductor.org/packages/release/bioc/html/CATALYST.html), [muscat](https://bioconductor.org/packages/release/bioc/html/muscat.html), [SpatialExperiment](https://www.bioconductor.org/packages/release/bioc/html/SpatialExperiment.html); now postdoc at [CNAG](https://www.cnag.eu/teams/genome-research-unit/single-cell-genomics-team))

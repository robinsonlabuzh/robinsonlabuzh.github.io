...
tbl_helena <- data.frame(
  ...
  bio = c("Helena Lucia Crowell", 
          paste0("In collaboration with the [Bodenmiller lab](http://www.bodenmillerlab.com) lab, ", 
                 ...
                 "differential analysis into the package. Currently, I am working my MScs thesis project, ", 
                 "which is predicated on differential discovery for scRNA-seq data."), 
...
## Alumni
- Helen Lindsay (postdoc, author of CrispRVariants; now at [EPFL](https://www.epfl.ch/))
...
- Malgorzata Nowicka (PhD student, author of [DRIMSeq](https://bioconductor.org/packages/DRIMSeq) and 
[cytofWorkflow](https://bioconductor.org/packages/cytofWorkflow/); now at [Hoffman La Roche](https://www.roche.ch/))
...
- Imran Fanaswala (Research Assistant, worked on assembly with PacBio and Illumina DNA-seq)
- Lourdes Rosano González (MSc student, analyzed transformations of CyTOF data)
...
- Angelo Duò (MSc student, compared scRNA-seq clustering algorithms)
- Amr Elriedy (MSc student, analyzed isoform detection using PacBio cDNA-seq)

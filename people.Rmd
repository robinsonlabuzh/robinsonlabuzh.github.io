...
tbl_izaskun <- data.frame(
  ...
  bio = c("Izaskun Mallona",
          ...
          paste0("I am mainly interested in gene expression modulation, as it lays the ground for any cell fate. ",
                 ...
                 "How are gene expression programs coded? how do they adapt during development? ",
                 "and disease? To mine the presumable genome-wide determinants of this phenomenon ",
                 "I'm fond of integrating gene expression and epigenomic data, and to develop methods for doing so. "),
          paste0("BSc Computer Engineering, Open University of Catalonia (2014)<br/>",
                 "PhD, Technical University of Cartagena (2012)<br/>",
                 "MSc Agriculture Engineering, Technical University of Cartagena (2008)<br/>",
                 "MSc Biology, University of Murcia (2007)</br>"))
)

tbl_lukas <- data.frame(
  img = "![](img/thumbnail/lukas.jpg)", 
  bio = c("Lukas Weber", 
          paste0("<i class='fa fa-desktop'></i> [Website](https://scholar.google.ch/citations?user=M8uPSzMAAAAJ)<br>", 
                 "<i class='fa fa-twitter'></i> Twitter [\\@lmwebr](https://twitter.com/lmwebr)<br>", 
...
tbl_stephan <- data.frame(
  ...
  bio = c("Stephan Schmeing", 
          ...
          paste0("MSc in Astro, Particle and Nuclear physis (2014), TU Munich<br>", 
...
tbl_fiona <- data.frame(
  ...
  bio = c("Ruizhu Huang", 
          paste0("My major research interest is in the development and application of statistical ", 
                 ...
                 "signal aggregation."), 
          paste0("MSc in Biostatistics (2015), University of Zurich<br>", 
...
tbl_stephany <- data.frame(
  ...
  bio = c("Stephany Orjuela", 
          ...
          paste0("MSc in Biology (2017), University of Zurich<br>", 
...
tbl_stefan <- data.frame(
  ...
  bio = c("Stefan Milosavljevic", 
          ...
          paste0("MSc in Computational Biology and Bioinformatics (2015), ETH Zurich and University of Zurich<br>", 
...
tbl_helena <- data.frame(
  ...
  bio = c("Helena Lucia Crowell", 
          ...
          paste0("MSc in Computational Biology & Bioinformatics (present), ETH Zurich<br>", 

...
tbl_elyas <- data.frame(
  ...
  bio = c("Elyas Heidari",  
          paste0("I am a Master student of Computational Biology & Bioinformatics at ETH university. I am interested",
                 ...
                 " for biomedical data. I have developed [MUVIS](https://baio-lab.github.io/muvis/index.html) for general medical data analysis and [SeqLearner](http://seqlearner.readthedocs.io/) for semi-supervised learning on biological sequences."
                  ), 

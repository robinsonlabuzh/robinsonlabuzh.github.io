...
tbl_stefan <- data.frame(
  ...
  bio = c("Stefan Milosavljevic",
          ...
          paste0("MSc in Computational Biology and Bioinformatics (2017), ETH Zurich and University of Zurich<br>", 
                 "BSc in Biology (2015), Universit?? de Lausanne"))
)
...
- Lourdes Rosano Gonz??lez (MSc student, analyzed transformations of CyTOF data)
...
- Angelo Du?? (MSc student, [compared scRNA-seq clustering algorithms](https://f1000research.com/articles/7-1141/v2))

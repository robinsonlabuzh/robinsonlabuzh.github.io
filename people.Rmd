...
tbl_imran <- data.frame(
  ...
  bio = c(
    ...
    paste0(
      ...
      "His research has spanned various fields (robotics, phylogenetics, DNA-assembly, neuroscience), but often ",
      "within the machine-learning/AI context (and more recently, \"ModelOps\"). He strives for succint, yet readable, code and prose."
      ), 
    paste0(

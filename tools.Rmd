...
----------|---------------|-----------------------------------
[aroma.affymetrix](http://aroma-project.org/) | **Mark D Robinson** | An open-source R framework for microarray analysis
...
[diffcyt](http://bioconductor.org/packages/release/bioc/html/diffcyt.html) | **Lukas M Weber** | Statistical methods for differential discovery in high-dimensional cytometry data

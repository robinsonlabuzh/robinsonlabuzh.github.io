...
R packages:  
<div id="stickers">
[![](stickers/ARMOR.png)](https://github.com/csoneson/ARMOR)[![](stickers/ARPEGGIO.png)](https://github.com/supermaxiste/ARPEGGIO)[![](stickers/BANDITS.png)](https://github.com/SimoneTiberi/BANDITS)[![](stickers/CATALYST.png)](http://bioconductor.org/packages/CATALYST/)[![](stickers/countsimQC.png)](https://bioconductor.org/packages/countsimQC/)[![](stickers/CrispRVariants.png)](http://bioconductor.org/packages/CrispRVariants/)[![](stickers/DAMEfinder.png)](https://github.com/markrobinsonuzh/DAMEfinder)[![](stickers/DESpace.png)](https://github.com/peicai/DESpace)[![](stickers/diffcyt.png)](http://bioconductor.org/packages/diffcyt/)[![](stickers/distinct.png)](https://github.com/SimoneTiberi/distinct)[![](stickers/DRIMSeq.png)](http://bioconductor.org/packages/DRIMSeq/)[![](stickers/edgeR.png)](http://bioconductor.org/packages/edgeR/)[![](stickers/iCOBRA.png)](http://bioconductor.org/packages/iCOBRA/)[![](stickers/iSEE.png)](http://bioconductor.org/packages/iSEE/)[![](stickers/muscat.png)](https://github.com/HelenaLC/muscat)[![](stickers/pipeComp.png)](https://github.com/plger/pipeComp)[![](stickers/regsplice.png)](http://bioconductor.org/packages/regsplice/)[![](stickers/scDblFinder.png)](https://github.com/plger/scDblFinder)[![](stickers/sosta.png)](https://bioconductor.org/packages/sosta)[![](https://github.com/Bioconductor/BiocStickers/raw/devel/SpatialExperiment/SpatialExperiment.png)](https://bioconductor.org/packages/SpatialExperiment)[![](stickers/spatialFDA.png)](https://bioconductor.org/packages/spatialFDA)[![](stickers/treeclimbR.png)](https://github.com/fionarhuang/treeclimbR)[![](stickers/TreeHeatmap.png)](https://github.com/fionarhuang/TreeHeatmap)[![](stickers/TreeSumExp.png)](https://github.com/fionarhuang/TreeSummarizedExperiment)
</div>
...
[sosta](http://bioconductor.org/packages/sosta/) | **Samuel Gunz** <br>**Mark D Robinson** | Analysis of anatomical tissue structures in spatial omics data
[spatialFDA](http://bioconductor.org/packages/spatialFDA/) | **Martin Emons**<br>**Samuel Gunz**<br>Fabian Scheipl<br>**Mark D Robinson** | Spatial multi-sample co-localisation analysis with spatial statistics
...
[pasta](https://robinsonlabuzh.github.io/pasta/00-home.html) | **Martin Emons**<br>**Samuel Gunz**<br>**Helena Crowell**<br>Malte Kuehl<br>**Izaskun Mallona**<br>Reinhard Furrer<br>**Mark D. Robinson** | Webpage of vignettes on spatial statistics for spatial omics data in `R` and `python`

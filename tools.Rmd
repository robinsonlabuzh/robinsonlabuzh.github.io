...
Name      | Author(s)     | Description
----------|---------------|-----------------------------------
[cytometry-clustering-comparison](https://github.com/lmweber/cytometry-clustering-comparison) | **Lukas M Weber** | Comparison of clustering methods for high-dimensional<br>single-cell flow and mass cytometry (CyTOF) data ([Weber and Robinson, 2016](https://www.ncbi.nlm.nih.gov/pubmed/27992111))

...
<div id="stickers">
[![](stickers/ARMOR.png)](https://github.com/csoneson/ARMOR)[![](stickers/ARPEGGIO.png)](https://github.com/supermaxiste/ARPEGGIO)[![](stickers/BANDITS.png)](https://github.com/SimoneTiberi/BANDITS)[![](stickers/CATALYST.png)](http://bioconductor.org/packages/CATALYST/)[![](stickers/countsimQC.png)](https://bioconductor.org/packages/countsimQC/)[![](stickers/CrispRVariants.png)](http://bioconductor.org/packages/CrispRVariants/)[![](stickers/DAMEfinder.png)](https://github.com/markrobinsonuzh/DAMEfinder)[![](stickers/diffcyt.png)](http://bioconductor.org/packages/diffcyt/)[![](stickers/distinct.png)](https://github.com/SimoneTiberi/distinct)[![](stickers/DRIMSeq.png)](http://bioconductor.org/packages/DRIMSeq/)[![](stickers/edgeR.png)](http://bioconductor.org/packages/edgeR/)[![](stickers/iCOBRA.png)](http://bioconductor.org/packages/iCOBRA/)[![](stickers/iSEE.png)](http://bioconductor.org/packages/iSEE/)[![](stickers/muscat.png)](https://github.com/HelenaLC/muscat)[![](stickers/pipeComp.png)](https://github.com/plger/pipeComp)[![](stickers/regsplice.png)](http://bioconductor.org/packages/regsplice/)[![](stickers/scDblFinder.png)](https://github.com/plger/scDblFinder)[![](https://github.com/Bioconductor/BiocStickers/raw/master/SpatialExperiment/SpatialExperiment.png)](https://bioconductor.org/packages/SpatialExperiment)[![](stickers/treeclimbR.png)](https://github.com/fionarhuang/treeclimbR)[![](stickers/TreeHeatmap.png)](https://github.com/fionarhuang/TreeHeatmap)[![](stickers/TreeSumExp.png)](https://github.com/fionarhuang/TreeSummarizedExperiment)

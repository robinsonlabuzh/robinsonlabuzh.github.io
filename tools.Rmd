...
<center>
[![](stickers/ARMOR.png){width=3cm}](https://github.com/csoneson/ARMOR)[![](stickers/CATALYST.png){width=3cm}](http://bioconductor.org/packages/CATALYST/)[![](stickers/countsimQC.png){width=3cm}](https://bioconductor.org/packages/countsimQC/)[![](stickers/CrispRVariants.png){width=3cm}](http://bioconductor.org/packages/CrispRVariants/)[![](stickers/DAMEfinder.png){width=3cm}](https://github.com/markrobinsonuzh/DAMEfinder)</br>[![](stickers/diffcyt.png){width=3cm}](http://bioconductor.org/packages/diffcyt/)[![](stickers/DRIMSeq.png){width=3cm}](http://bioconductor.org/packages/DRIMSeq/)[![](stickers/edgeR.png){width=3cm}](http://bioconductor.org/packages/edgeR/)[![](stickers/iCOBRA.png){width=3cm}](http://bioconductor.org/packages/iCOBRA/)[![](stickers/iSEE.png){width=3cm}](http://bioconductor.org/packages/iSEE/)</br>[![](stickers/muscat.png){width=3cm}](https://github.com/HelenaLC/muscat)[![](stickers/pipeComp.png){width=3cm}](https://github.com/plger/pipeComp)[![](stickers/regsplice.png){width=3cm}](http://bioconductor.org/packages/regsplice/)[![](stickers/treeAGG.png){width=3cm}](https://github.com/markrobinsonuzh/treeAGG)[![](stickers/TreeSumExp.png){width=3cm}](https://github.com/fionarhuang/TreeSummarizedExperiment)
</center>

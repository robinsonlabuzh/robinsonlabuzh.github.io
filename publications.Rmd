...
biorxiv_github <- rbind(
  ...
  c(doi = "10.12688/f1000research.73600.2", github = "https://github.com/plger/scDblFinder"),
  c(doi = "10.12688/f1000research.73493.3", github = "https://github.com/markrobinsonuzh/os_monitor"),
...
biorxiv_software <- rbind(
  ...
  c(doi = "10.12688/f1000research.73600.2", software = "https://bioconductor.org/packages/scDblFinder"),
  c(doi = "10.12688/f1000research.73493.2", software = "http://pubassistant.ch/"),
...
unlisted_publications <- data.frame(	
  ...
  authors = c("Van den Berge K, Hembach KM, Soneson C, Tiberi S, Clement L, Love MI, Patro R, Robinson MD",
              "Burja B, Paul D, Tastanova A, Edalat SG, Gerber R, Houtman M, Elhai M, Bürki K, Staeger R, Restivo G, Lang R, Sodin-Semrl S, Lakota K, Tomšič M, Levesque MP, Distler O, Rotar Ž, Robinson MD and Frank-Bertoncelj M"),	
  volume = c("2",""),	
  issue = c(""),	
  pages = c("139-173",""),	

...
biorxiv_dois <- c("10.1101/2020.12.11.420885",
                  "10.1101/2020.11.24.394213",
                  "10.1101/2020.11.11.355693",
                  "10.1101/2020.11.09.374447",
                  "10.1101/2020.10.15.340596",
                  #"10.1101/713412",
                  "10.1101/2020.07.17.209072",
                  "10.1101/2020.07.16.206193",
                  "10.1101/2020.06.10.136010",
...
pmid_github <- rbind(
  ...
  #c(pmid = "33257685", github = "https://github.com/HelenaLC/muscat"),
...
biorxiv_github <- rbind(
  c(doi = "10.1101/2020.06.08.140608", github = "https://github.com/fionarhuang/treeclimbR_article"),
...
biorxiv_data <- rbind(
  ...
  c(doi = "10.1101/2020.12.11.420885", data = "https://doi.org/10.6084/m9.figshare.13341200"),
...
pmid_software <- rbind(
  ...
  c(pmid = "32178699", github = "http://bioconductor.org/packages/release/bioc/html/BANDITS.html")
)
biorxiv_software <- rbind(
  c(doi = "10.1101/349738", software = "https://bioconductor.org/packages/release/bioc/html/diffcyt.html"),
  c(doi = "10.1101/2020.06.08.140608", github = "https://github.com/fionarhuang/treeclimbR"),
  c(doi = "10.1101/2020.07.16.206193", github = "https://github.com/supermaxiste/ARPEGGIO"),
  c(doi = "10.1101/2020.11.09.374447", github = "https://github.com/retogerber/censcyt"),
  c(doi = "10.1101/2020.12.11.420885", github = "https://www.bioconductor.org/packages/release/bioc/html/CellMixS.html"),
  c(doi = "10.1101/2020.07.17.209072", github = "https://github.com/schmeing/ReSeq"),
...
group_members <- c("Robinson MD", "Mark D. Robinson", "Mark D Robinson", 
                   ...
                   "Almut Luetge", "Luetge A", "Almut Lütge",
...
write.table(bind_rows(summ), "publications.csv", quote=FALSE, sep=";", row.names = FALSE)
saveRDS(bind_rows(summ), file="publications.rds")
write.table(biorxiv, "preprints.csv", quote=FALSE, sep=";", row.names = FALSE)

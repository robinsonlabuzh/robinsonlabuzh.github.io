...
## PubMed IDs to add
pmid_add <- c("11743205", "15761153", "23857251", "26493315", "30002819", "30356428")
...
biorxiv_dois <- c("10.1101/533646", "10.1101/550749", "10.1101/574525")
...
pmid_github <- rbind(
  ...
  c(pmid = "28663787", github = "https://github.com/markrobinsonuzh/cytofWorkflow"),
...
biorxiv_github <- rbind(
  c(doi = "10.1101/574525", github = "https://github.com/csoneson/NativeRNAseqComplexTranscriptome")
)
...
pmid_software <- rbind(
  ...
  c(pmid = "29028961", software = "https://github.com/csoneson/countsimQC"),
...
summ$pubyear[summ$pmid=="28663787"] <- 2019 # hack to get F1000 cytofWorkflow to a 2019 date

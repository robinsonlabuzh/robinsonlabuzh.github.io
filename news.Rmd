...
tbl_news <- data.frame(matrix(vector(), 0, 3, dimnames = list(c(), c("date","title","news"))), stringsAsFactors = FALSE)
...
tbl_news[nrow(tbl_news) + 1,] <- list("28.5.2018","New website","This new lab website is finished.")

```

[//]: # Add Mark's twitter feed
<a class="twitter-timeline" data-height="400" href="https://twitter.com/markrobinsonca?ref_src=twsrc%5Etfw">Tweets by markrobinsonca</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
